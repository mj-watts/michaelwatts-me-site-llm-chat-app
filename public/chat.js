...
// Update colour themes to match parent site

window.onmessage = function (e) {
  const [k, v] = e.data.split(":");
...
let chatHistory = [
  {
    role: "assistant",
    content: "Hi there. I hope you are well, how can I help you today?",
  },
];
...
whoButton.addEventListener("click", () => {
  quickMessage(whoButton.getAttribute("title"));
});

whatButton.addEventListener("click", () => {
  quickMessage(whatButton.getAttribute("title"));
});
